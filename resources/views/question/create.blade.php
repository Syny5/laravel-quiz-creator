                    ...
                    <form action="/questionnaires/{{ $questionnaire->id }}/questions" method="post">
                        ...
                        <div class="form-group">
                            <fieldset>
                                ...
                                <small id="choicesHelp" class="form-text text-muted">Add simple choices.</small>
                                <div>
                                    <div class="form-group">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input name="answers[][answer]" type="text" class="form-control" id="answer4" value="{{ old('answers.2.answer') }}" aria-describedby="choicesHelp" placeholder="Enter Choice 4">
